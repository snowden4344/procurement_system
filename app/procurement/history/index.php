...
<head>
    ...
    <title>Contract Award History</title>
</head>
<body class="bg-black">
...
<div class="sidebar col-xl-2 col-lg-2 col-md-4 col-12 bg-111 h-100 bottom-0 position-fixed top-0 bottom-0 shadow_custom" id="sidebar">
    ...
    <ul class="mt-5 pt-5 px-0">
        ...
        <a href="#" class="bg-222 d-block link-hover py-3 text-white text-decoration-none d-flex "><p class="col-1 d-xl-block d-lg-block d-md-block d-none mb-0"></p><p class="col-xl-11 col-lg-11 col-md-11 col-12 text-xl-start text-md-start text-lg-start text-center mb-0"><i class="fa fa-history me-2"></i> History</p></a>
...
<div class="main_part d-flex py-3 justify-content-between">
    ...
    <div class="actual_content col-xl-10 col-lg-10 col-12">
        ...
        <div class="bidder_dashboard col-11 mx-auto my-3">
            <h2 class="text-white fw-bold mb-4">Contract Award History</h2>
                    ...
                    <div class="card-body">
                        <table class="d-table table table-striped table-borderless custom_table small_font" id="awards">
                            ...
                            <tr>
                                ...
                                <th class="text-light">Contract Awarded To</th>
                                <th class="text-light">Date Applied</th>
                                <th class="text-light">Deadline</th>
                                <th class="text-light">Date Awarded</th>
                            </tr>
                            </thead>
                            <tbody>
                            <?php
            ...
            b.business_name,
            ca.date_awarded,
            q.date_created AS date_applied
        FROM contract_awards ca
        LEFT JOIN request_for_quotations rfq ON ca.rfq_number = rfq.rfq_number
        LEFT JOIN bidders b ON ca.bidder_id = b.id
        LEFT JOIN quotations q ON ca.rfq_number = q.rfq_number";
                            ...
                            if ($result->num_rows > 0) {
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    echo "<td class='text-light py-3'>" . $row['business_name'] . "</td>";
                                    echo "<td class='text-light py-3'>" . $row['date_applied'] . "</td>";
                                    echo "<td class='text-light py-3'>" . $row['deadline'] . "</td>";
                                    echo "<td class='text-light py-3'>" . $row['date_awarded'] . "</td>";
                                    echo "</tr>";
                                }
                            } else {
